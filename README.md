...
This project doesn't use any libraries for solving the differential equations, because it is one of the main goals of the course to implement the algorithms ourselves.
